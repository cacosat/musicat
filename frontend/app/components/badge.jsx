...
export default function Badge(props) {
    ...
    const badgeToDisplay = () => {
        if (props.type === 'artist') {
            return (
                <div className={`w-fit px-2 py-1 flex justify-center items-center gap-1 border ${artistBorderColor} rounded-full bg-gradient-to-b ${artistBgGradient} to-transparent`}>
                    <div>
            ...
            return (
                <div className={`w-fit px-2 py-1 flex justify-center items-center gap-1 border ${albumBorderColor} rounded-full bg-gradient-to-b ${albumBgGradient} to-transparent`}>
                    <div>
                        <svg width="12" height="13" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            return (
                <div className={`w-fit px-2 py-1 flex justify-center items-center gap-1 border ${songBorderColor} rounded-full bg-gradient-to-b ${songBgGradient} to-transparent`}>
                    <div>
                        <svg width="12" height="13" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
