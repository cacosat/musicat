...
export default function Component() {
  return (
    <div className="relative border border-gray-700 border-opacity-50 rounded-lg overflow-hidden shadow-lg max-w-[658px]">
      {/* Contenedor de fondo con imagen y desenfoque */}
      <div className="absolute inset-0 z-0">
        <Image
          src="/We are the grand.jpeg" // Asegúrate de reemplazar esto con tu imagen de fondo real
          alt="Fondo borroso"
          layout="fill"
          objectFit="cover"
          className="blur-sm"
